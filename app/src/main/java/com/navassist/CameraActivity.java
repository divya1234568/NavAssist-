...
public class CameraActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_speak2).setOnClickListener(v -> speak(currentDetection.isEmpty() ? "Nothing detected yet" : currentDetection));
            ...
            txtRec.process(image)
                .addOnSuccessListener(result -> {
                    ...
                    if (!text.isEmpty()) {
                        ...
                        runOnUiThread(() -> { tvObjectName.setText("No text found"); tvObjectPos.setText("Point at a sign or label"); });
                    }
                })
            ...
            objDet.process(image)
                .addOnSuccessListener(objects -> {
                    if (!objects.isEmpty()) {
                        ...
                        String primaryName = "Object"; int primaryConf = 0;
                        String primaryPos = "";
                        ...
                        labeler.process(image)
                            .addOnSuccessListener(labels -> {
                                if (!labels.isEmpty()) {
                                    ...
                                    runOnUiThread(() -> { tvObjectName.setText("Scanning..."); tvObjectPos.setText("Move camera slowly"); tvStatus.setText("🟡 Looking..."); });
                                }
                            })
                            .addOnCompleteListener(t -> proxy.close());
                        return;
